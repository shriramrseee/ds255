...
\begin{document}
	...
	\begin{enumerate}
		...
		Also, if there are concurrent requests to access an I/O device like disk, OS serializes the requests during the process of disk scheduling.
